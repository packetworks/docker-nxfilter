...
```docker run -it nxfilter-data -p 80:80 -p 53:53 packetworks/nxfadmin:latest```  
...
```docker run --volumes-from nxfilter-data -p 80:80 -p 53:53 --rm packetworks/nxfadmin:latest```
